...
```toml
[dependencies]
durable-workflow = "=2.0.0-beta.14"
```

Version `2.0.0-beta.14` requires Rust `1.86` or newer and includes the complete
Durable Workflow 2.0 beta baseline described below.

## Compatibility

Rust SDK `2.0.0-beta.14` is supported with server `2.0.0-beta.14`, control plane
