...
if [[ "$compatibility_authority" != "protocol-manifests" || "$server_compatibility" != "2.0.0-rc.57" || "$qualified_server_version" != "2.0.0-rc.57" || "$server_worker_protocols" != ">=1.19,<2.0" ]]; then
